...
class TumorSample:
    ...
    def _resolve_CnEvents(self, seg_file, input_type='auto', purity=1, ploidy=2):
        if input_type == 'auto':
            ...
            elif seg_file.endswith('.seg'):
                input_type = 'timing_format'
            else:
                input_type = 'moo'
            ...
            with open(seg_file, 'r') as fh:
                ...
                for line in fh:
                    try:
                        ...
                        seg_tree[chrN].add(Interval(start, end, (self.sample_name, {
                            'cn_a1': cn_a1, 'cn_a2': cn_a2,
                            'ccf_hat_a1': 0., 'ccf_high_a1': 0., 'ccf_low_a1': 0.,
                            'ccf_hat_a2': 0., 'ccf_high_a2': 0., 'ccf_low_a2': 0.
                        })))
                    except ValueError:
                        continue
